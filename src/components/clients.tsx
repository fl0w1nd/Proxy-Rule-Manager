                            ...
                            <div className="space-y-2">
                                {formData.transforms.length === 0 ? (
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <span className="flex h-7 w-7 items-center justify-center rounded-lg border border-primary/12 bg-primary-soft text-xs font-semibold text-primary shadow-[var(--shadow-xs)]">
                                                    {index + 1}
                                                </span>
                                                <span className="text-sm font-medium">转换器</span>
                                            </div>
                                            <Button
                                                type="button"
                                                variant="ghost"
